...
- [x] Submit a Pull-Request to merge `firstName-lastName` Branch into master on **your fork, don't mak Pull Requests against Lambda's repository**.
...
- [x] Explain the difference between `Relational Databases` and `SQL`.
        ...
        Relational Databases as in RDBMS are software that are used to create databases
        as SQL is the structured query language to create the databases.

- [x] Why do tables need a `primary key`?

    to be uniqely identified inside the databas
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
      ...
      a table to meet them in the middle and store both sets of keys
